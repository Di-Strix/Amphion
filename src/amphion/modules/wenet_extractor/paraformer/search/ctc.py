...
from amphion.modules.wenet_extractor.paraformer.search.ctc_prefix_score import CTCPrefixScore
from amphion.modules.wenet_extractor.paraformer.search.ctc_prefix_score import CTCPrefixScoreTH
